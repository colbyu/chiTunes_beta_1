...
class ItemtypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itemtype" do
    assert_difference('Itemtype.count') do
      post itemtypes_url, params: { itemtype: { itemtypedescription: @itemtype.itemtypedescription } }
    end
  ...
  test "should update itemtype" do
    patch itemtype_url(@itemtype), params: { itemtype: { itemtypedescription: @itemtype.itemtypedescription } }
